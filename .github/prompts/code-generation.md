Transform this Powershell script into a polished, beginner-friendly project by refactoring the code, adding clear instructional comments, and generating a complete markdown tutorial.

1. **Refactor the code**  
   - Apply standard PowerShell best practices  
   - Ensure code follows the PowerShell style guide  
